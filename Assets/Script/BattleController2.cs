...
public class BattleController2 : MonoBehaviour  {
	...
	{
		statusText.text = "Agora é o seu turno garoto escolha novamente a mágia para acabar logo com isso e irmos para proxima parte do treinamento!";
	}
	void Player1Fight()
	{
	...
	{
		statusText.text = "cof.. cof que mágia forte garoto mas agora sou eu que ataco!";
